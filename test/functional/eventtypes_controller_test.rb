...
class EventtypesControllerTest < ActionController::TestCase
  ...
  test "should create eventtype" do
    assert_difference('Eventtype.count') do
      post :create, eventtype: { eventtypedescription: @eventtype.eventtypedescription, eventtypename: @eventtype.eventtypename }
    end
  ...
  test "should update eventtype" do
    put :update, id: @eventtype, eventtype: { eventtypedescription: @eventtype.eventtypedescription, eventtypename: @eventtype.eventtypename }
    assert_redirected_to eventtype_path(assigns(:eventtype))
  end
